            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                   <div class="carousel-item active">
                        <img class="" src="imagenes/labsol/banner1b.jpeg" alt="First slide">
                   </div>
                   <div class="carousel-item">
                        <img class="" src="imagenes/labsol/banner1b.jpeg" alt="Second slide">
                   </div>
                   <div class="carousel-item">
                        <img class="" src="imagenes/labsol/banner1b.jpeg" alt="Third slide" height="305px">
                   </div>
               </div>
           </div>
          </div>
